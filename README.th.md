...
- **ขั้นโค้ดในแซนด์บ็อกซ์** node `Code` รัน Python หรือ JavaScript ในโปรเซสลูกที่ถูกจำกัดเวลาและหน่วยความจำ
...
- **สร้างจากคำอธิบาย** คลิกขวาบนแคนวาส บอกว่างานคืออะไร แนบภาพหน้าจอของปุ่มที่ต้องกด โมเดลจะได้รับ
  ข้อกำหนดที่สร้างจากรายการnodeโดยตรง คำตอบของมันถูกตรวจด้วยตัวแยกวิเคราะห์ตัวเดียวกับที่ใช้เปิดไฟล์
